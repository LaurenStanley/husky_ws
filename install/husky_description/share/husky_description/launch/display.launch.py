...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='husky_description').find('husky_description')
    default_model_path = os.path.join(pkg_share, 'urdf/husky.urdf')
